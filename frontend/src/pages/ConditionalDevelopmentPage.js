/* frontend/src/pages/ConditionalDevelopmentPage.js */

import React, { useState, useEffect } from "react";
import { fetchLeagues, fetchTeamsByLeague, fetchFootballersByTeam, generateGraph, fetchConditionalData } from "../services/conditional_api";
import "../styles/ConditionalDevelopmentPage.css";
import citizenshipIcon from "../assets/images/citizenship_icon.png";
import birthdayIcon from "../assets/images/birthday_icon.png";
import conditionalPageIcon from "../assets/images/conditioning_page_icon.png";

const graphOptions = [
  { value: "VO2 Max Progression Over 30 Days", label: "VO2 Max Progression Over 30 Days" },
  { value: "Daily Lactate Levels Monitoring", label: "Daily Lactate Levels Monitoring" },
  { value: "Training Intensity Progression", label: "Training Intensity Progression"},
  { value: "Recovery Distribution", label: "Recovery Distribution"},
  { value: "VO2 Max Trend with Regression", label: "VO2 Max Trend with Regression"},
  { value: "Conditional Goal Progress Overview", label: "Conditional Goal Progress Overview"}
];
...
const ConditionalDevelopmentPage = () => {
  ...
  const [graphType, setGraphType] = useState("VO2 Max Progression Over 30 Days");
  ...
  // Fetch conditional data for selected footballer and graph type
  useEffect(() => {
  ...
  return (
    <div className="conditional-development-page">
      <div className="selectors">
        ...
        <div className="conditional-page-icon">
          <img src={conditionalPageIcon} alt="Conditional Page Icon" className="icon-image" />
        </div>
      ...
      <div className="graph-container">
        {graphPath && (
          <img
              ...
              alt="Generated Conditional Progress Graph"
