/* frontend/src/services/performance_api.js */

const API_BASE_URL = "http://localhost:5056/api/performance";
...
// Function to fetch performance data for a footballer
export const fetchPerformanceData = async (payload) => {
  try {
